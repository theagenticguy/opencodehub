 ...
 *
 * These pins are the authoritative contract consumed by the W2-A.2 downloader
 * (`codehub setup --embeddings`) and by `codehub doctor` at runtime. SHA256
 * values are taken from
 *   .erpaval/sessions/002/research-embeddings.yaml §2.files
 * and were computed locally against the upstream Hugging Face repo at commit
