...
// Belt-and-suspenders Python / JS dependency auditors. Both are P1 but
// language-gated. osv-scanner catches the multi-ecosystem baseline;
...
// Priority-2 scanners. These ship alongside P1 but are opt-in via
...
// Scanner catalog expansion (2026-04-20): ruff, hadolint additions.
