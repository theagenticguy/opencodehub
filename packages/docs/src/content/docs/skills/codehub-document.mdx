...
Primary artifact generator. Ports codeprobe's proven `/document` pattern to
...
See [ADR 0009](/opencodehub/architecture/adr-0009/) for the full contract.
...
- [ADR 0007 — Artifact factory](/opencodehub/architecture/adr-0007/)
- [ADR 0008 — codeprobe pattern port](/opencodehub/architecture/adr-0008/)
- [ADR 0009 — Output conventions](/opencodehub/architecture/adr-0009/)
