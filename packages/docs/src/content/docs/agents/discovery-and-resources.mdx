---
title: Discovery and resources for agents
description: Where AI coding agents and their operators find OpenCodeHub.
sidebar:
  order: 4
---
...
The MCP server registers 28 tools at
...
<LinkCard
  ...
  description="Where OCH is listed for one-click MCP discovery."
/>
