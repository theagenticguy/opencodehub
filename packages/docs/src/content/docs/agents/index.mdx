...
PR verdict — all behind 28 MCP tools served by one local binary. The
...
Restart your editor. Your agent now has 28 MCP tools, all prefixed
...
<CardGrid>
  <LinkCard
    ...
    description="Plugin + code-analyst subagent + 11 skills."
  />
  <LinkCard
    title="Cursor"
  ...
  <LinkCard
    ...
    description="mcp_config.json — Cascade can call all 28 tools after restart."
  />
  <LinkCard
    title="OpenCode"
