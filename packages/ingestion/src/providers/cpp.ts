 ...
 *
 * Imports: `#include` only (clean-room treatment of `import` modules is
 * deferred until we pick up modules — Clang's proposal). `kind` is
 * `package-wildcard` for each include.
 *
