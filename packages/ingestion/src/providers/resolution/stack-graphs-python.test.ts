...
// providers add behavioural hooks (see Stream O / Stream V). The resolver
...
test("getResolver: typescript provider also maps to stack-graphs strategy (v2 router)", () => {
  // Stream O enrolled the TS family into the stack-graphs router. The same
  // public name dispatches internally by provider.id.
