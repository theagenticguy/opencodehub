...
//
// The `LanguageId` union is intentionally duplicated here (Wave 3c parallel
// build). The parse-infra sibling package (Wave 3b) will define its own copy;
// Wave 5 will reconcile the two into a shared neutral location. Keep both
