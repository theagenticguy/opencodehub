 ...
 *     is NOT folded into graphHash per the roadmap.
 */

import { createHash } from "node:crypto";

import { type Embedder, EmbedderNotSetupError, openOnnxEmbedder } from "@opencodehub/embedder";
...
async function runEmbeddings(ctx: PipelineContext): Promise<EmbedderPhaseOutput> {
  ...
  // 2. Open embedder; EMBEDDER_NOT_SETUP is a graceful degradation.
