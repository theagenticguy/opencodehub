/**
 * Shared incremental-scope consumer helpers (Stream L, W2-E.4).
 *
 * Stream L flips the four expensive post-parse phases — crossFile, mro,
...
/**
 * Snapshot passed from Stream L phases into their own runners. `active`
...
/**
 * Resolve the Stream L incremental view from a phase's context.
 *
