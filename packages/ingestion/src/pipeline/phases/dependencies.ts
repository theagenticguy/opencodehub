 ...
 * (manifest, dep) rather than per-importing-source-file. W2-I5.2 will
 * refine this to per-file once the parse phase exposes package
 * resolution data.
 *
 * Determinism:
 ...
 *
 * Phase dependency: `scan`. The phase is designed to also depend on the
 * ProjectProfile phase once W2-H7 lands — we only need the scan output
