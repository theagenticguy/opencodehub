...
Restart Claude Code so it picks up the new agent, skills, and hooks. The auto-reindex hook is a no-op until `codehub analyze` has run at least once in each repo.
